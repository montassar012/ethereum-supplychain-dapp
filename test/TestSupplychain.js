...
contract('SupplyChain', function(accounts) {
    ...
    // beforeEach(async () => {
    //     supplyChain = await SupplyChain.new({ from: accounts[0] });

    // });

    // afterEach(async () => {
    //     await supplyChain.kill({ from: accounts[0] });
    // });
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {     
        ...
        var tx =await supplyChain.sellItem(upc, productPrice,{from: originFarmerID})  
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        var tx = await supplyChain.buyItem(upc, {from: distributorID, value: web3.utils.toWei("1", "ether")})
        ...
        // Verify the result set
        assert.equal(resultBufferOne[2],distributorID, 'Invalid owner registered')
        assert.equal(resultBufferTwo[5], 4, 'Error: Invalid item State') 
        assert.equal(resultBufferTwo[6],distributorID, 'Invalid distributor registered')
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne[2],retailerID, 'Invalid owner registered')
        assert.equal(resultBufferTwo[5], 6, 'Error: Invalid item State') 
        assert.equal(resultBufferTwo[7],retailerID, 'Invalid retailer registered')
